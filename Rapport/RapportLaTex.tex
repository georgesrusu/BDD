...
\par Nous allons maintenant essayer le moteur de recherche, nous allons rechercher les établissement qui sont des bar. Voyons ce que ça donne:\\
...
Encore une fois l'admin peut voir les caractéristique de l'établissement et peux ou non modifier certaine information.
...
\par Comme fonctionnalité dans la page d'accueil un petit affichage des dernier établissement créer, dans la page de présentation de chaque établissement nous avons la carte de localisation, les scores affiché avec des étoiles. Le client a la possibilité de changer sont mot de passe ainsi que son email. En ce qui concerne l'historique de l'activité d'un utilisateur, sont historique reprend les commentaire dans l'orde du plus récent vers le plus ancien et aussi l'historique des tag apposé.
